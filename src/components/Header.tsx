      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <h1 className="text-lg font-bold leading-tight text-foreground">MedLit AI</h1>
            <p className="text-xs text-muted-foreground">Summarizer</p>
          </div>
        </div>

        <nav className="hidden md:flex items-center gap-6">
          <a href="/dashboard" className="text-sm font-medium text-foreground transition-colors hover:text-primary">
            Dashboard
          </a>
      ...
      {isMenuOpen && (
        <div className="border-t bg-card md:hidden">
          <nav className="container mx-auto flex flex-col gap-4 p-4">
            ...
            <a href="/history" className="text-sm font-medium text-muted-foreground">
              History
            </a>
